...
public class VRDurationSlider : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        valueMax = soundSource.rateValue;
    }
    ...
    void Update()
    {
        ...
        soundSource.SetSustainLength(InterpolateOverCurve(curve, valueMin, valueMax, ((transform.localPosition.z + 0.085f) * 5.8823f)));
