...
// patch
SqrOsc sqrOsc => LPF sqrFilter => Dyno sqrCompressor => Gain sqrGain => ADSR envelope => dac;
...
sustainValue::second => dur sustain;
        ...
        toneBlend * 0.65 => sqrGain.gain;
        (1.0 - toneBlend) * 1.35 => sinGain.gain;
