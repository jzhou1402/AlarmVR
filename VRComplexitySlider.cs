...
public class VRComplexitySlider : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        soundSource.SetScaleValues(InterpolateOverCurve(curve, valueMin, valueMax, ((transform.localPosition.z + 0.085f) * 5.8823f)));
